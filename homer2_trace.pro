...
print,bg,trace_param.bgcolor
	...
	IF (NLINES GT 0) THEN auto_trace,geom,trace_param
	IF (N_ELEMENTS(PLT_X) GT 0) THEN PLOT_FIELD,GEOM,X_AXIS,Y_AXIS,PLT_X,PLT_Y,PLT_Z
...
pro auto_trace,geom,trace_param
...
;DEVICE,/ENCAPSULATED,/COLOR,BITS_PER_PIXEL=8,FILENAME='TEST.EPS'
	...
	window,/free,xsize=700,ysize=600
	ind_w3d = !D.WINDOW
